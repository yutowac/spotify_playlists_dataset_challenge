...
with st.sidebar.form(key='basic info'):
    # not unique
    st.sidebar.text("・Playlist: " + str(len(l_names_playlist)) + '')
    st.sidebar.text("・Tracks : " + str(sum(l_num_tracks)) + '')
    st.sidebar.text("・Albums : " + str(sum(l_num_albums)) + '')
    st.sidebar.text("・Artists: " + str(sum(l_num_artists)) + '')
    st.sidebar.text("・Follows:  " + str(sum(l_num_followers)) + '')
